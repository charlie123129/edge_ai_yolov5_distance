...
def run(
        ...
        weights=ROOT / 'runs/train/yolov5x_1000/weights/best.pt',  # weights path
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/yolov5s_1000/weights/best.pt', help='model.pt path(s)')
